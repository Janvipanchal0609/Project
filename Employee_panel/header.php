        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-desktop "></i>Category <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a class="nav-link <?php active('add_cate')?>"href="add_cate"><i class="fa fa-table <?php active('add_cate.php')?>"></i>Add Category</a>
                            </li>
                            <li>
                                <a  href="manage_cate"><i class="fa fa-table <?php active('manage_cate')?> "></i>Manage Category</a>
                            </li>
                     ...
                     <li>
                        <a href="#"><i class="fa fa-shopping-cart "></i>Product<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a  href="add_prod"><i class="fa fa-table <?php active('add_prod')?>"></i>Add Product</a>
                            </li>
                            <li>
                                <a  href="manage_prod"><i class="fa fa-table <?php active('manage_prod')?>"></i>Manage Product</a>
                            </li>
                    ...
                    <li>
                        <a href="Feedback"><i class="fa fa-user "></i>Feedback</a>
                        
                    </li>
					
					<li>
                        <a href="manage_cont"><i class="fa fa-user "></i>manage_cont</a>
